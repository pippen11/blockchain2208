...
// "use strict";
// //엄격 모드: ES6 안됨, var안됨 빡세게 코드를 작성하겠다.

// // DB Table에 관련해서 전부 관리한다.
// //MVC<< Model, View, Controller
// // 프로그래밍의 기초?
// //디자인 패턴의 중 하나로 보통의 프로그래밍에서 많이 사용된다.
// //View: 보이는거 , Controller: 조작 , 통제하는거 , Model : 저장하는거

// const Sequelize = require("sequelize");
// // sequelize: DB에 연결한다.-> 무슨 DB든 다 가능하다 . mySQL와 함께 사용하는
// // 경우를 계속 하고있다 MongoDB << noSQL(관계 시스템이 없다.)
// // mysql2 : DB에 연결한다-> mySQL에접근
