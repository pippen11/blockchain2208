...
contract("EthSwap", ([deployer, account1, account2]) => {
  ...
  describe("EthSwap deployment", () => {
    ...
    it("deployed", async () => {
      ...
      console.log("testToken CA : ", token.address);
    ...
    // testToken 컨트랙트 배포한 사람의 EOA를 알고 싶다.
    ...
    it("token - balanceOf()", async () => {
      ...
      // testToken에 있는 transfer() 함수 실행해서 토큰 전송
