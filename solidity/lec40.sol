...
// 255까지밖에표현이안되니까 256은 0이된다 uint8은 2의 256-1 0~255이다

// Safemath는 overflow를 방지하는 라이브러리이다
library SafeMath{
    //0~255;
    function add(uint8 a, uint8 b) internal pure returns (uint8){
        //a:1 b:255 -> a+b = 256 >=1 따라서 256은 0이된다 에러가난다 0.8이후부터는 overflow잡는듯?
...
//0.8버전이후부터는 솔리디티 자체내에서 overflow를 잡아줌 에러로 나온다